...
class Ui_MainWindow(object):
    ...
    def get_control_path(self):
        if self.num_controls.isChecked():
            control_directory = QtGui.QFileDialog.getExistingDirectory(None, 'Select Directory', 'C:\\')
            control_directory = str(control_directory).replace('/', '\\')
            self.control_text.setText(control_directory)
        else:
            control_filepath = QtGui.QFileDialog.getOpenFileName(None, 'Open File', 'C:\\')
            control_filepath = str(control_filepath).replace('/', '\\')
            self.control_text.setText(control_filepath)
